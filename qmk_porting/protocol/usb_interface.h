...
#define DYNAMICLIGHTING_EP_SIZE 64
...
enum {
    ...
    DYNAMICLIGHTING_OUT_EP = DYNAMICLIGHTING_IN_EP - 0x80,
#endif
#ifdef RAW_ENABLE
...
#define DYNAMICLIGHTING_IN_SIZE     DYNAMICLIGHTING_EP_SIZE
#define DYNAMICLIGHTING_IN_INTERVAL 1

#define DYNAMICLIGHTING_OUT_EP_SIZE     DYNAMICLIGHTING_EP_SIZE
#define DYNAMICLIGHTING_OUT_EP_INTERVAL 1
