...
#ifndef BATTERY_MEASURE_CALIBRATION_PIN
#warning "Battery measure calibration pin undefined."
#endif
...
#ifdef BATTERY_MEASURE_CALIBRATION_PIN
#if BATTERY_MEASURE_CALIBRATION_PIN != A7 && BATTERY_MEASURE_CALIBRATION_PIN != A8 &&   \
    BATTERY_MEASURE_CALIBRATION_PIN != A9 && BATTERY_MEASURE_CALIBRATION_PIN != A4 &&   \
    BATTERY_MEASURE_CALIBRATION_PIN != A5 && BATTERY_MEASURE_CALIBRATION_PIN != A6 &&   \
    BATTERY_MEASURE_CALIBRATION_PIN != A0 && BATTERY_MEASURE_CALIBRATION_PIN != A1 &&   \
    BATTERY_MEASURE_CALIBRATION_PIN != A2 && BATTERY_MEASURE_CALIBRATION_PIN != A3 &&   \
    BATTERY_MEASURE_CALIBRATION_PIN != A15 && BATTERY_MEASURE_CALIBRATION_PIN != A14 && \
    BATTERY_MEASURE_CALIBRATION_PIN != A13 && BATTERY_MEASURE_CALIBRATION_PIN != A12
#error "Invalid battery measure calibration pin!"
#endif
#endif
