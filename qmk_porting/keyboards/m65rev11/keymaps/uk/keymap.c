...
*/
  [_ADJ] = LAYOUT_ortho_5x13e(
      RGB_MOD, RGB_RMOD, A(KC_F2), BLE_SLOT0, BLE_SLOT1, BLE_SLOT2, BLE_SLOT3, _______, _______, _______, _______, RGB_M_T , RGB_M_SW, _______,
      ...
      RGB_TOG, USB_MODE, BLE_ALL_CLEAR , _______, _______, _______, _______, _______, _______, _______, _______, RGB_M_TW, RGB_M_G),
};
// clang-format on
