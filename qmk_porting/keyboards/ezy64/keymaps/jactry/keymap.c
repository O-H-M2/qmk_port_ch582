...
/* Some customize keys. */
#define CK_BATI BATTERY_INDICATOR
#define CK_BLE0 BLE_SLOT0
#define CK_BLE1 BLE_SLOT1
#define CK_BLE2 BLE_SLOT2
#define CK_LSFT TD(TD_LSFT_CAPS)
#define CK_USB  USB_MODE
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
    ...
    [1] = LAYOUT_all(/* 1: fn */
        ...
        _______, CK_BLE0, CK_BLE1, CK_BLE2, CK_USB,  _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, CK_BATI, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
