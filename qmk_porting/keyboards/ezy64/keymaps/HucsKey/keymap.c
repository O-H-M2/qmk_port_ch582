...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_all(/* 2: fn */
           ...
           BATTERY_INDICATOR,   KC_BTN1,   KC_MS_U,   KC_BTN2,   _______,  _______,    KC_P7,    KC_P8,   KC_P9, RGB_SPD, RGB_SPI,  RGB_VAD, RGB_VAI, _______,
                       MO(3),   KC_MS_L,   KC_MS_D,   KC_MS_R,   _______,  _______,    KC_P4,    KC_P5,   KC_P6, _______, RGB_HUD,  RGB_HUI, RGB_TOG,
                     _______,   KC_BTN1,   KC_BTN3,   KC_BTN2,   _______,   KC_NUM,    KC_P1,    KC_P2,   KC_P3, RGB_SAD, RGB_SAI,  _______, _______, _______,
                     _______,   _______, _______, _______, _______, _______, _______, _______, _______),
    [2] = LAYOUT_all(/* 1: fn */
                      KC_GRV,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12,  KC_DEL,
                     _______, _______,   KC_UP, _______, _______, _______, _______,  KC_INS, KC_HOME, KC_PGUP, _______, _______, _______, _______,
                       MO(3), KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, _______,  KC_DEL,  KC_END, KC_PGDN, _______, _______, RGB_TOG,
                     _______, _______, _______, _______, _______, _______, NK_TOGG, _______, _______, _______, _______, _______, _______, _______,
                     _______, _______, _______, _______, _______, _______, _______, _______, _______),
    [3] = LAYOUT_all(/* 3: fn */
                     _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, BLE_ALL_CLEAR,
                     _______, _______, KC_WH_U, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,       _______,
                     _______, KC_WH_L, KC_WH_D, KC_WH_R, _______, _______, _______, _______, _______, _______, _______, _______, _______,
                     _______, _______, _______, _______, _______, _______, NK_TOGG, _______, _______, _______, _______, _______, _______,       _______,
                     _______, _______, _______, _______, _______, _______, _______, _______, _______),
    [4] = LAYOUT_all(/* 4: fn */
