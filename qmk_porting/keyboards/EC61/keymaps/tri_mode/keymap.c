...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_all(/* 0: qwerty */
              ...
              LT(2, KC_CAPS),    KC_A,    KC_S,    KC_D,    KC_F,           KC_G,           KC_H,             KC_J,    KC_K,    KC_L, KC_SCLN,       KC_QUOT,  KC_ENT,
                     KC_LSFT,    KC_Z,    KC_X,    KC_C,    KC_V,           KC_B,           KC_N,             KC_M, KC_COMM,  KC_DOT, KC_SLSH, RSFT_T(KC_UP), _______,
                     KC_LCTL, KC_LGUI, KC_LALT,  KC_SPC, KC_RALT, LT(1, KC_LEFT), LT(2, KC_DOWN), RCTL_T(KC_RIGHT)),
    [1] = LAYOUT_all(/* 1: fn */
                      KC_GRV, BLE_SLOT0, BLE_SLOT1, BLE_SLOT2, BLE_SLOT3, ESB_MODE, _______,  _______, _______, _______, _______,RGB_RMOD, RGB_MOD,  KC_DEL,
