...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_all(/* 1: fn */
                     ...
                     MO(3)  , _______, MO(2)  , _______, _______, KC_MUTE, KC_VOLD, KC_MPLY),
    [2] = LAYOUT_all(/* 2: fn */
                     ...
                     MO(3)  , _______, MO(2)  , _______, _______,  RGB_HUD, RGB_VAD, RGB_HUI),
    [3] = LAYOUT_all(/* 3: fn */
                     ...
                     _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
                     MO(3)  , _______, MO(2)  , _______, _______, _______, _______, _______),
    [4] = LAYOUT_all(/* 2: fn */
                     _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
                     _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
                     _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    ...
    [8] = LAYOUT_all(/* 2: fn */
                     ...
                     _______, _______, _______, _______, _______, _______, _______, _______),
    [9] = LAYOUT_all(/* 2: fn */
                     _______, BLE_SLOT0, BLE_SLOT1, BLE_SLOT2, BLE_SLOT3, _______, _______, _______, _______, _______, _______, _______, _______, _______,
